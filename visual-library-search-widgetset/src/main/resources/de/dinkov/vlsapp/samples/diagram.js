var d3diagram = d3diagram || {};

d3diagram.diagram = function(diagramElement,treeData){
console.debug("misho iska data" ,treeData);
    ...
    var baseSvg = d3.select(diagramElement).append("svg")
