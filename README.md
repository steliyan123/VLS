...
- visual-library-search-widgetset: widgetset, custom client side code and dependencies to widget add-ons
- visual-library-search-ui: main application module, development time
- visual-library-search-production: module that produces a production mode WAR for deployment
